  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white">Affiliate Network</h2>
          <p className="text-slate-500 dark:text-slate-400 font-medium">Manage your Introduction Broker (IB) relationships and commission tracking.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Active IBs</p>
              <h3 className="text-3xl font-black text-slate-900 dark:text-white">{affiliatesData.length}</h3>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Total Network Capital</p>
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">IB Commissions Built</p>
              <h3 className="text-3xl font-black text-slate-900 dark:text-white">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        <div className="p-8 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
          <h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">IB Performance Matrix</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 font-medium">Ranked by top converting affiliates.</p>
        </div>
        <div className="p-6">
          <div className="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700">
            <table className="w-full text-sm text-left">
              <thead className="bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
                <tr>
                  <th className="px-6 py-5 font-bold text-slate-700 dark:text-slate-300">Broker ID</th>
                  <th className="px-6 py-5 font-bold text-slate-700 dark:text-slate-300">Client Tranches</th>
                  <th className="px-6 py-5 font-bold text-slate-700 dark:text-slate-300">Sum of Referred Capital</th>
                  <th className="px-6 py-5 font-bold text-slate-700 dark:text-slate-300">Generated Commission</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-200 dark:divide-slate-700 bg-white dark:bg-slate-900">
                {affiliatesData.map((ib) => (
                  <tr key={ib.name} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-20 text-center">
                      <div className="flex flex-col items-center justify-center text-slate-500 dark:text-slate-400">
                        ...
                        <p className="font-bold text-lg text-slate-900 dark:text-white mb-2">Network is Empty</p>
                        <p className="font-medium max-w-sm">No active Introducing Brokers found. When you assign an IB flag to an investor, their aggregate stats will appear here.</p>
                      </div>
                    </td>
                  </tr>
                )}
