...
export function InvestorProfileView({
  ...
  const [emailNotifications, setEmailNotifications] = useState(
    investor.emailNotifications || false,
  );
    ...
    <div className="space-y-6 max-w-5xl mx-auto animate-in fade-in duration-500">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
              Manage your personal details, alerts, and payment preferences
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-center relative overflow-hidden">
          ...
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5 relative z-10">
            Current Balance
          </span>
          <span className="text-2xl font-black text-slate-900 dark:text-white relative z-10">
            {formatCurrency(
              investor.endingCapital,
              investor.baseCurrency || "USD",
            )}
          </span>
        </div>
        <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-center relative overflow-hidden">
          ...
          <span className="text-2xl font-black text-emerald-600 dark:text-emerald-500 relative z-10">
            {formatCurrency(
              investor.feeCollected,
              investor.baseCurrency || "USD",
            )}
          </span>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-center relative overflow-hidden">
          ...
          <span className="text-2xl font-black text-amber-600 dark:text-amber-500 capitalize relative z-10">
            {investor.memberTier || investor.group || "Standard"}
          </span>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <div
                className={`w-12 h-6 flex items-center rounded-full p-1 transition-colors ${emailNotifications ? "bg-rose-500" : "bg-slate-300 dark:bg-slate-700"}`}
              >
                <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-slate-500 mt-1">
              These details will be used for your withdrawals.
            </p>
          </div>

          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
              Receiving QR Code (Data/URL)
            </label>
            <div className="relative">
            ...
            <p className="text-xs text-slate-500 mt-1">
              Optional. Provide a data link to render a fast-payment QR code for
              managers.
            </p>
          </div>
        </div>
